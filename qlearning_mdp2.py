...
color = '#dfdfdf'
ax2.plot(list(range(numEpisodes)), print_maxQvalue[6], color=color, label="Q(S7,a)")
ax2.text(list(range(numEpisodes))[-1], print_maxQvalue[6][-1], "S7", ha='left', va='center', color='#555555')

color = '#dddddd'
ax2.plot(list(range(numEpisodes)), print_maxQvalue[7], color=color, label="Q(S8,a)")
ax2.text(list(range(numEpisodes))[-1], print_maxQvalue[7][-1], "S8", ha='left', va='center', color='#555555')

color = '#cdcdcd'
ax2.plot(list(range(numEpisodes)), print_maxQvalue[8], color=color, label="Q(S9,a)")
ax2.text(list(range(numEpisodes))[-1], print_maxQvalue[8][-1], "S9", ha='left', va='center', color='#555555')

color = '#cccccc'
ax2.plot(list(range(numEpisodes)), print_maxQvalue[9], color=color, label="Q(S10,a)")
ax2.text(list(range(numEpisodes))[-1], print_maxQvalue[9][-1], "S10", ha='left', va='center', color='#555555')

color = '#bcbcbc'
ax2.plot(list(range(numEpisodes)), print_maxQvalue[10], color=color, label="Q(S11,a)")
ax2.text(list(range(numEpisodes))[-1], print_maxQvalue[10][-1], "S11", ha='left', va='center', color='#555555')

color = '#aaaaaa'
ax2.plot(list(range(numEpisodes)), print_maxQvalue[11], color=color, label="Q(S12,a)")
ax2.text(list(range(numEpisodes))[-1], print_maxQvalue[11][-1], "S12", ha='left', va='center', color='#555555')
